...
The remainder of this paper is structured as follows. [@sec-data] describes the data used in the analysis, including the sources and key variables and their visualizations.[@sec-model] outlines the models applied to estimate fire severity and identify key factors. [@sec-results] presents the results of the analysis. [@sec-discussion] provides an interpretation of the results in the context of current fire safety practices and suggests potential improvements. Finally, [@sec-appendixa] includes details about variable selection and cleaning, with the visualization of all variables in the analysis dataset; [@sec-appendixb] is a supplementary datasheet that explains the building of the analysis dataset; [@sec-appendixc] outlines the idealized methodology for conducting this study, given a budget of $100K.
