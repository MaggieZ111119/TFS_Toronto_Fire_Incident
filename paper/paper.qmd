...
# Idealized Survey Methodology and Data Collection for Fire Severity Study in Toronto
This study investigates the severity of fire incidents in Toronto to enhance resource allocation and optimize the effectiveness of the Toronto Fire Services (TFS). I work to understand key factors contributing to fire severity, including fire origin areas and ignition sources. I will also explore the effectiveness of public fire response systems, such as fire alarms sprinkler, smoke detection systems, to see how see thier presenace when fire incidence came and their effectiveness on reducsing fire. The methodology focuses on using observational data from fire incident records, public reports, and survey, and with statistical modeling to identify critical patterns and guide recommendations for TFS operations with understaingd of current fire infratcure presense.
